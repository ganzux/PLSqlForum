...
<HTML>
	...
	<HEAD>
		...
		<LINK href="../alumnos/resources/css/hoja.css" rel="stylesheet" type="text/css">
...
HTP.P('	<!-- Cabecera de la WeB -->
	...
	<!-- Imagen en cabecera -->
	<div align="center"><A HREF="http://www.alvarito.net"><img src="../alumnos/resources/jpg/webito.gif" width="150" height="75" border=0></A></div>

	<!-- Tabla de opciones de Usuario -->
	<table width="75%"  border="0" align="center" cellspacing="5">
	<tr>
		<!-- F.A.Q. -->
		<td><div align="center" class="mainmenu"><A HREF="foro.faq"><img src="../alumnos/resources/jpg/faq.gif" border=0>F.A.Q.</A></div></td>
		<!-- Des / Conectarse -->
		<td><div align="center" class="mainmenu">');
    IF nomb IS NOT NULL THEN
      HTP.P('<A HREF="foro.salir"><img src="../alumnos/resources/jpg/desc.gif" border=0> Desconectarse ['||nomb||']</A></div>');
    ELSE
      HTP.P('<A HREF="foro.login"><img src="../alumnos/resources/jpg/registrese.gif" border=0> Inicio de Sesión</A></div>');
    END IF;

    HTP.P('</div></td>

		<!-- Perfil de Usuario -->
		<td><div align="center" class="mainmenu"><A HREF="foro.perfil"><img src="../alumnos/resources/jpg/perfil.gif" border=0> Perfil</A></td>
		<!-- Lista de temas -->
		<td><div align="center" class="mainmenu"><A HREF="foro.muestra_temas"><img src="../alumnos/resources/jpg/temas.gif" border=0> Lista de Temas</A></div></td>
		<!-- Nuevo Tema -->
		<td><div align="center" class="mainmenu"><A HREF="foro.nuevo_tema"><img src="../alumnos/resources/jpg/nuevotema.gif" border=0> Nuevo Tema</A></div></td>
		<!-- Lista de usuarios -->
		<td><div align="center" class="mainmenu"><A HREF="foro.lista_usuarios"><img src="../alumnos/resources/jpg/lista.gif" border=0>Lista de Usuarios</A></div></td></td>
		<!-- Buscar -->
		<td><div align="center" class="mainmenu"><A HREF="foro.buscar"><img src="../alumnos/resources/jpg/buscar.gif" border=0>Buscar</A></div></td>
  </tr>
  ...
  IF id_tema_pasada IS NOT NULL THEN
    ...
    LOOP
	  ...
	  IF num_usu = REG.id_usuario THEN
		HTP.P('<TD><center><A HREF="foro.edita?mensaje='||REG.id||'"><img src="../alumnos/resources/jpg/edit.gif" alt="Editar mensaje" border=0></A>'||REG.contenido||'</TD>');
	  ...
	  IF REG.archivo IS NOT NULL THEN
		HTP.P('<div align="center"><A HREF="docs/'||REG.archivo||'"><img src="../alumnos/resources/jpg/download.gif" alt="Bajar Archivo '||REG.archivo||'" border=0></A></div>');
	  ELSE
		HTP.P('');
	  END IF;
	  HTP.P('</TD>');
	...
	<table width="75%"  border="0" align="center" cellspacing="0">
      ...
      IF busca_usuario IS NOT NULL THEN
            HTP.P('<A HREF="foro.nuevo_mensaje?id_tema_pasada='||id_tema_pasada||'"><img src="../alumnos/resources/jpg/reply.gif" border=0 alt="Escribir Nuevo Mensaje"></A>');
      END IF;
      HTP.P('</div></td>
	    <td width="5%"></td>
	    <td width="30%">');
...
HTP.P('<script src="../alumnos/resources/js/md5.js" type="text/javascript"></script>
<form name="datos">
...
IF galleta.num_vals!=0 THEN
  ...
  IF chorro IS NULL THEN
    ...
    <script src="../alumnos/resources/js/md5.js" type="text/javascript"></script>');
  ...
  IF id_usua IS NOT NULL THEN
    ...
    cabecera('Perfil de Usuario de '||id_usua||'');
        ...
        <tr bgcolor="#CCCCCC">
          ...
          HTP.P('<A HREF="foro.enviar_mail?direccion='||temp||'"><img src="../alumnos/resources/jpg/email.gif" border="0"></A></td>
        </tr>
      </table>
...
nomb_usua := busca_usuario;
    ...
    IF REG.archivo IS NOT NULL THEN
      HTP.P('<td><div align="center"><A HREF="docs/'||REG.archivo||'"><img src="../alumnos/resources/jpg/download.gif" alt="Bajar Archivo '||REG.archivo||'" border=0></A></div></td>');
    ELSE
      HTP.P('<td></td>');
    END IF;
	...
	END IF;
	  ...
	  HTP.P('<td align="center">'||REG.id||'</td>
	    ...
	    IF REG.email IS NOT NULL THEN
	      HTP.P('<td><A HREF="foro.enviar_mail?direccion='||REG.email||'"><div align="center"><img src="../alumnos/resources/jpg/email.gif" border="0"></div></A></td>');
	    ELSE
	      HTP.P('<td></td>');
	    END IF;
...
FOR contador IN 1..coll_resp.count LOOP
  ...
  htp.p('  <tr>
    ...
    <td><img src="../alumnos/resources/jpg/ok.gif" border=0></td>
  </tr>');
END LOOP;
commit;
HTP.P('</TABLE>
